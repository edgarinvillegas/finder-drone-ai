...
from models import YoloDetectionModel, SsdDetectionModel, FaceDetectionModel, CustomDetectionModel, FasterRcnnDetectionModel, FasterRcnnFlipDetectionModel, CatDetectionModel
import cv2
import time
...
frame = cv2.imread('images/whisky-drone-detected.jpg')
